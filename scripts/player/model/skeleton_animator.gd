...
func configure_blending_times():
	set_blend_time("idle", "running", 0.5)
	set_blend_time("idle", "idle_jump_start", 0.5)
	...
	set_blend_time("idle", "idle_jump_midair", 0.5)
	
	set_blend_time("running", "running_jump_start", 0.5)
